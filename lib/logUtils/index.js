...
export default class LogUtils {
     ...
     */
    static logDefault(data, dataTitile = '[mUtils] log_utils default => ') {
     ...
     */
    static logInfo(data, dataTitile = '[mUtils] log_utils info => ') {
     ...
     */
    static logSuccess(data, dataTitile = '[mUtils] log_utils success => ') {
     ...
     */
    static logError(data, dataTitile = '[mUtils] log_utils error => ') {
     ...
     */
    static logWarning(data, dataTitile = '[mUtils] log_utils warning => ') {
     ...
     * })
     */
    static logBeauty(text = '疏影横斜水清浅', options) {
     ...
     */
    static group(dataTitile = '[mUtils] log_utils group => ', color = LogUtils.defaultColor) {
        console.group(`%c${dataTitile}`, `color: ${color}; font-weight: bold`);
    }
    /**
     * log打印一个group组  折叠的
     */
    static groupCollapsed(dataTitile = '[mUtils] log_utils group_collapsed => ', color = LogUtils.defaultColor) {
